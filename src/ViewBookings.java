   ...
   public ViewBookings(String userName){
    ...
    private void initComponents() {
        ...
        bookingsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Event title", "1st class tickets", "2nd class ticket", "Corport. ticket", "Total price", "Booking date"
            }
        ) {
    ...
    public ArrayList<Booking>bookingsList() {
        ...
        String retrievBookingsData = "SELECT events.title, bookings.number_of_class_1st_ticket, bookings.number_of_class_2nd_ticket, bookings.number_of_class_Org_ticket, bookings.total, bookings.booking_date FROM bookings " +
        ...
        try{
            ...
            Booking booking;
            while(result.next()){
                booking = new Booking(result.getString("title"), result.getInt("number_of_class_1st_ticket"), result.getInt("number_of_class_2nd_ticket"),
    ...
    public void show_bookings(){
        ...
        for(int i = 0; i< bookList.size(); i++){
            row[0] = bookList.get(i).getEventTitle();
            row[1] = bookList.get(i).getFirstClassTickets();
            row[2] = bookList.get(i).getSecondClassTickets();
            row[3] = bookList.get(i).getCorpTickets();
            row[4] = bookList.get(i).getTotal();
            row[5] = bookList.get(i).getBookingDate();
            model.addRow(row);
        }
